...
update company set company_address="bangalore" where comapany_name="infosys";
update company set employes="1900" where comapany_name="technoware";
update company set company_address="bangalore" where comapany_name="infosys";
...
update food set coun=3,pieces=6 where food_id=1;
update food set inches=9.95,pieces=5 where food_id=2;
update food set f_name="burger",pieces=3 where food_id=3;
update food set f_date="2023-07-04",pieces=6 where food_id=10;
update food set inches=18.95,coun="italy side" where food_id=7;

delete from food where food_id=5;
delete from food where food_id=10;
